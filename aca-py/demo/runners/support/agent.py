...
class DemoAgent:
    def __init__(
        ...
        **params,
        ...
        # )
        self.wallet_name="capena_wallet"
        self.seed="qeTVdenWbye6KbDBA59qsFPUDn2EDDR5"
        self.wallet_key = "1234567890"
        self.did = "KSnqCcaeZakqnyqqdz482Q"
        self.wallet_stats = []
    ...
    def get_agent_args(self):
        ...
        print("We have some parameters: ", result)
